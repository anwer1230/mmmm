...
# ===========================
# إعداد التطبيق و SocketIO
# ===========================
app = Flask(__name__)
app.secret_key = os.urandom(24)
socketio = SocketIO(app, cors_allowed_origins="*", async_mode='threading')  # استخدام الوضع threading

# ===========================
# مجلد الجلسات وتخزين بيانات المستخدم
# ===========================
SESSIONS_DIR = "sessions"
if not os.path.exists(SESSIONS_DIR):
    os.makedirs(SESSIONS_DIR)

USERS = {}  # لتخزين بيانات كل مستخدم: client, settings, thread, is_running

# ===========================
# وظائف حفظ واسترجاع الإعدادات
# ===========================
